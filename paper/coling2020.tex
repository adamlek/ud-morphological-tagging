...
\begin{document}
    ...
    %\end{table}
     ...
     methods not to be uniformly efficient. % at derive information
...
\begin{figure}  
    ...
    (1.77,0.861928171)
        ...
        \legend{Sum,Mean,RNN,Fst}
    	\end{axis}
        \end{tikzpicture}
        \caption{Method accuracy plotted against average number of BPE
     tokens per text token in all languages in the feature extraction
     training regime.}

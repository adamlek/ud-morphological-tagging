...
%%%
    ...
    %
        ...
        feature extraction, which is understandable given that more
        parameters are tuned to the task. However, the difference is
...
\begin{tikzpicture} 
    ...
    With regards to the performance of the different methods for
     ...
     is larger. \jp{than what?} This is expecially prominent in \cref{fig:bpe_lens}
     where the green line is above the red and blue for most word lengths.

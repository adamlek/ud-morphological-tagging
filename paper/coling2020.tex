...
\begin{tikzpicture} 
    ...
    %
         By using a method that takes
     the order of elements into account, one is able to collect
    ...
    \subsubsection{Fst method}
     ...
     suffieciently powerful to pool the relevant information into the
     first BPE token.
    ...
    \subsubsection{Sum and Mean}
     ...
     advantage of $.9$ percentage points for summation.
                ...
                This discrepancy suggest that by averaging, we are

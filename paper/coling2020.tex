...
\begin{figure}%{r}{8cm}
    ...
    % sequence classification in eight different languages with varying typology, using a
    ...
    % methods, summation and averaging, and better than letting the
    % model push all the predictive information to the first BPE token.


    %In conclusion, our results show that for morphological sequence classifcation on eight diffrent languages with varying morphology, using an RNN to compose word representations from BPE tokens is more efficient than combining them with commutative methods,  
